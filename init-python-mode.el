...
(autoload 'pydb "pydb" "Run the pydb Python debugger." t)
...
(setq pdb-path 'd:/soft/python/Lib/pdb.py
...
(when (load "flymake" t)
  ...
  (add-to-list 'flymake-allowed-file-name-masks
               '("\\.py\\'" flymake-pyflakes-init flymake-simple-cleanup flymake-get-real-file-name)))
(add-hook 'find-file-hook 'flymake-find-file-hook)

;;outline mode for python
(add-hook 'python-mode-hook 'python-outline-hook)
